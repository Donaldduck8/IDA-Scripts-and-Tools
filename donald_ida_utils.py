...
def open_docked_pseudocode_view(ea):
    # Get active view
    active_view = ida_kernwin.get_current_viewer()
    active_view_title = ida_kernwin.get_widget_title(active_view)

    # Open pseudocode view
    pseudocode_view_title = f"Synced Disasm ({active_view_title})"
    pseudocode_view = ida_hexrays.open_pseudocode(ea, ida_hexrays.OPF_NEW_WINDOW)

    # Dock the disassembly view to the right of the active view
    ida_kernwin.set_dock_pos(active_view_title, pseudocode_view_title, ida_kernwin.WOPN_DP_RIGHT)

    return pseudocode_view
...
def open_synced_disassembly_view():
    ...
    # Sync the disassembly view to the active view
    ...
    # Dock the disassembly view to the right of the active view
    ida_kernwin.set_dock_pos(active_view_title, disasm_view_title, ida_kernwin.WOPN_DP_RIGHT)
